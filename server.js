...
function generatePDF(formData, lang) {
  return new Promise((resolve) => {
    ...
    doc.fontSize(9).fillColor('#666666')
       .text(`Rita Last Versicherungen – rita@rita-last.com – kfz-frontend.rita-last.com`, { align: 'center' });
